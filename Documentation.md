...
4. There is no standard way of documenting at Greenstand, each lead is using their own method. For example, repositories may have a Read Me, a wiki, a Gitbook page, or may have no documentation at all.
...
| Perform an audit of Greenstand’s existing information and documentation. Include what exists now, where located, updates needed, gaps, and enhancement opportunities. | Week 2 - 6 | Adding document status to the MD file on Github with links and descriptions of all documentation.
...
| Identify problem areas and outline the current process for onboarding core audiences. | Weeks 2-3 | MD file on Github with links to relevant onboarding files, recommend enhancements, additions/deletions, and processes for making updates ongoing |
...
| Communicate as necessary to raise awareness of the new portal and explain the process for document migration. | Week 7-24 | Migrated documents.
...
2. Technical Writers include all persons writing documentation, including engineers and technical leaders who are documenting code, and/or otherwise creating project documentation, and tech leaders whose input and involvement are critical in the review and validation of the documentation surrounding this complex microservice platform.
3. Greenstand Tokens, (tokens linked to sponsored) will be purchased from farmers and allocated to volunteer contributors for contributing to the documentation.
...
| Volunteer Engagement | Decrease friction to "first contribution | Reduce the number of messages and questions asked by new contributors by 50% by week 24 |
